        ...
        <section className="bg-gradient-to-b from-gray-50 to-white py-12 mt-8">
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">शेतकरी कृषी सेवा केंद्र - भोसेपाटी ता. पंढरपूर जि. सोलापूर</p>
            </div>
            ...
            <Accordion type="single" collapsible className="bg-white rounded-2xl shadow-lg overflow-hidden">
              ...
              <AccordionItem value="item-1" className="border-b border-gray-200">
                <AccordionTrigger className="px-6 py-5 hover:bg-emerald-50 text-base font-semibold text-gray-800" data-testid="faq-q1">
                  शेतकरी सेवा केंद्र कुठे आहे?
                </AccordionTrigger>
                <AccordionContent className="px-6 py-4 text-gray-700 leading-relaxed" data-testid="faq-a1">
                  आमचे कृषी केंद्र भोसेपाटी चौक, टेंभुर्णी - पंढरपूर रोड ता. पंढरपूर जि. सोलापूर येथे स्थित आहे. आमच्या दुकानात सर्व प्रकारचे शेतीचे बियाणे, खत, हार्डवेअर, औषधे आणि व्यावसायिक मार्गदर्शन सेवा उपलब्ध आहेत. संपर्क करण्यासाठी +91 9767178462 या नंबरवर कॉल करा. आम्ही सकाळी 8:00 ते संध्याकाळी 8:00 पर्यंत सेवा देतो आणि शेतकऱ्यांना सर्वोत्तम कृषी उत्पादने व तांत्रिक मार्गदर्शन प्रदान करतो.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-2" className="border-b border-gray-200">
                <AccordionTrigger className="px-6 py-5 hover:bg-emerald-50 text-base font-semibold text-gray-800" data-testid="faq-q2">
                  पंढरपूर जवळ सर्वोत्तम कृषी दुकान कोणते आहे?
                </AccordionTrigger>
                <AccordionContent className="px-6 py-4 text-gray-700 leading-relaxed" data-testid="faq-a2">
                  शेतकरी कृषी सेवा केंद्र हे भोसेपाटी ता. पंढरपूर जि. सोलापूर परिसरातील सर्वोत्तम व विश्वासार्ह कृषी दुकान आहे. आमच्याकडे शेतीचे प्रमाणित बियाणे, सेंद्रिय व रासायनिक खते, कीटक व रोग नियंत्रण औषधे, शेती हार्डवेअर साधने आणि आधुनिक कृषी उपकरणे मोठ्या प्रमाणात उपलब्ध आहेत. आमची खासियत म्हणजे प्रत्येक उत्पादनासाठी तज्ञ मार्गदर्शन, स्पर्धात्मक किमती, घरपोच वितरण सेवा आणि शेतकऱ्यांना पिक व्यवस्थापनाचा मोफत सल्ला. आम्ही शेतकरी बांधवांना केवळ उत्पादने विकत नाही तर त्यांच्या शेतीच्या यशासाठी सतत मार्गदर्शन करतो.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-3" className="border-b border-gray-200">
                <AccordionTrigger className="px-6 py-5 hover:bg-emerald-50 text-base font-semibold text-gray-800" data-testid="faq-q3">
                  शेतकरी कृषी सेवा केंद्र येथे कोणत्या प्रकारची बियाणे, खते आणि औषधे उपलब्ध आहेत?
                </AccordionTrigger>
              ...
              <AccordionItem value="item-4" className="border-b border-gray-200">
                ...
                <AccordionContent className="px-6 py-4 text-gray-700 leading-relaxed" data-testid="faq-a4">
                  होय, नक्कीच! शेतकरी कृषी सेवा केंद्रात आम्ही केवळ उत्पादने विकत नाही तर शेतकऱ्यांना संपूर्ण तांत्रिक मार्गदर्शन व शेती सल्लामसलत मोफत देतो. आमच्याकडे अनुभवी कृषी तज्ञ आहेत जे पिक निवड, खत व्यवस्थापन, कीटक-रोग नियंत्रण, योग्य औषधांचा वापर, मृदा परीक्षण, पाण्याचे व्यवस्थापन आणि उत्पन्न वाढीसाठी आधुनिक तंत्रज्ञान यावर सविस्तर मार्गदर्शन करतात. तुम्ही कोणत्याही शेती समस्येसाठी +91 9767178462 वर संपर्क करू शकता किंवा थेट आमच्या केंद्रावर येऊन तज्ञांशी चर्चा करू शकता. आम्ही शेतकऱ्यांच्या यशासाठी कटिबद्ध आहोत.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-5" className="border-b border-gray-200">
                ...
                <AccordionContent className="px-6 py-4 text-gray-700 leading-relaxed" data-testid="faq-a5">
                  होय, आम्ही पंढरपूर, सोलापूर आणि आजूबाजूच्या सर्व गावांमध्ये घरपोच वितरण सेवा पुरवतो. तुम्ही WhatsApp (+91 9767178462) द्वारे किंवा फोन कॉलवर तुमची ऑर्डर देऊ शकता आणि आम्ही लवकरात लवकर तुमच्या शेतावर किंवा घरी उत्पादने पोहोचवतो. मोठ्या ऑर्डरसाठी मोफत डिलिव्हरी सेवा उपलब्ध आहे. आमचे वाहन दररोज सोलापूर जिल्ह्यातील विविध गावांमध्ये जाते आणि शेतकऱ्यांना त्यांच्या दारात आवश्यक बियाणे, खते, औषधे पोहोचवते. यामुळे शेतकऱ्यांना वेळ आणि वाहतूक खर्च वाचतो. आपल्या सेवेत आपले समाधान हा आमचा ध्यास आहे.
                </AccordionContent>
              </AccordionItem>
            ...
            <div className="mt-8 text-center">
              <p className="text-sm text-gray-500">
                शेतकरी कृषी सेवा केंद्र | भोसेपाटी | पंढरपूर | सोलापूर | शेतीचे बियाणे | खत | औषधे | हार्डवेअर | कृषी मार्गदर्शन
              </p>
            </div>
          </div>
        </section>
